    ...
    if push:
        ...
        for i, support in enumerate(location):
            valid_springs.append(
                {
                    "location": concept_geo.point_from_rhino_point(support),
        ...
        if valid_springs:
            ...
            logger.append("No valid point springs provided.")
        return logger
