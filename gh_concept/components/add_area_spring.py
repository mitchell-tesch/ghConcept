...
@hops.component(
    ...
    inputs=[
        ...
        hs.HopsNumber(
            "Point 1 R-axis rotational stiffness",
            "Point1_kMr",
        ...
        hs.HopsNumber(
            "Point 1 S-axis rotational stiffness",
            "Point1_kMs",
        ...
        hs.HopsNumber(
            "Point 2 R-axis rotational stiffness",
            "Point 2_kMr",
        ...
        hs.HopsNumber(
            "Point 2 S-axis rotational stiffness",
            "Point 2_kMs",
        ...
        hs.HopsNumber(
            "Point 3 R-axis rotational stiffness",
            "Point 3_kMr",
        ...
        hs.HopsNumber(
            "Point 3 S-axis rotational stiffness",
            "Point 3_kMs",
...
def add_area_spring(
    push: bool,
    model_file: str,
    boundary: list[rhino.PolylineCurve],
    name: list[str],
    ...
    if push:
        ...
        for i, area_boundary in enumerate(boundary):
            ...
            if valid:
                ...
                valid_areas.append(
                    {
                        "polygon": concept_geo.polygon_from_polyline(area_boundary),
        ...
        if valid_areas:
            ...
            logger.append("No valid spring areas provided.")
        return logger
