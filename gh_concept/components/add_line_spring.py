...
@hops.component(
    ...
    inputs=[
        ...
        hs.HopsString("Concept model", "Model",
                      ...
                      hs.HopsParamAccess.ITEM),
        hs.HopsCurve("Spring polyline", "SupportLine",
        ...
        hs.HopsNumber("Support elevation", "Elevation",
                      ...
                      hs.HopsParamAccess.LIST, True),
        hs.HopsNumber("Start R-axis stiffness", "Start_kFr",
                      "Spring stiffness in r-axis at start as list",
                      hs.HopsParamAccess.LIST, True),
        hs.HopsNumber("Start S-axis stiffness", "Start_kFs",
                      "Spring stiffness in s-axis at start as list",
                      hs.HopsParamAccess.LIST, True),
        hs.HopsNumber("Start Z-axis stiffness", "Start_kFz",
                      "Spring stiffness in z-axis at start as list",
                      hs.HopsParamAccess.LIST, True),
        hs.HopsNumber("Start R-axis rotational stiffness", "Start_kMr",
                      "Rotational spring stiffness about r-axis at start as list",
                      hs.HopsParamAccess.LIST, True),
        hs.HopsNumber("Start S-axis rotational stiffness", "Start_kMs",
                      "Rotational spring stiffness about s-axis at start as list",
                      hs.HopsParamAccess.LIST, True),
        hs.HopsNumber("End R-axis stiffness", "End_kFr",
                      "Spring stiffness in r-axis at end as list",
                      hs.HopsParamAccess.LIST, True),
        hs.HopsNumber("End S-axis stiffness", "End_kFs",
                      "Spring stiffness in s-axis at end as list",
                      hs.HopsParamAccess.LIST, True),
        hs.HopsNumber("End Z-axis stiffness", "End_kFz",
                      "Spring stiffness in z-axis at end as list",
                      hs.HopsParamAccess.LIST, True),
        hs.HopsNumber("End R-axis rotational stiffness", "End_kMr",
                      "Rotational spring stiffness about r-axis at end as list",
                      hs.HopsParamAccess.LIST, True),
        hs.HopsNumber("End S-axis rotational stiffness", "End_kMs",
...
def add_line_spring(push: bool, model_file: str, line: list[rhino.PolylineCurve], name: list[str],
    ...
    if push:
        ...
        for i, support_line, in enumerate(line):
            ...
            logger.extend(log)
            if valid:
                valid_springs.append({"line_segments": concept_geo.lines_from_polyline(support_line),
        ...
        if valid_springs:
            ...
            logger.append(f"No valid line springs provided.")
        return logger
