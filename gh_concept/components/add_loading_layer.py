...
@hops.component(
    ...
    inputs=[
        ...
        hs.HopsString("Concept model", "Model",
                      ...
                      hs.HopsParamAccess.ITEM),
        hs.HopsString("Layer name", "Name",
                      "Name of loading layer as list",
                      hs.HopsParamAccess.LIST),
        hs.HopsString("Layer type", "Type",
                      "Layer type as list\n\
...
def add_loading_layer(push: bool, model_file: str, layer_name: list[str], layer_type: list[str]):
    if push:
        logger = []
        ...
        for i, name in enumerate(layer_name):
            if layer_type[i].lower not in ["force", "shrink", "temp", "combo"]:
                ...
                continue
            # store valid
            valid_loading_layers.append({"layer_name": name,
        ...
        if valid_loading_layers:
            ...
            logger.append(f"No valid loading layers provided.")
        return logger
