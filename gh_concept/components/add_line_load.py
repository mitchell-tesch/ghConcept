...
@hops.component(
    ...
    inputs=[
        ...
        hs.HopsCurve("Load polyline", "Line",
...
def add_line_load(push: bool, model_file: str, layer_name: list[str], line: list[rhino.PolylineCurve],
    ...
    if push:
        ...
        valid_loads = []
        for i, load_line, in enumerate(line):
        ...
        if valid_loads:
            ...
            logger.append(f"No valid line loads provided.")
        return logger
