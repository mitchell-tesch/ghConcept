...
@hops.component(
    ...
    inputs=[
        ...
        hs.HopsInteger(
            "Priority", "Priority", "Priority of slab as list", hs.HopsParamAccess.LIST
        ),
        hs.HopsString(
            "Analysis behaviour",
            "Behaviour",
    ...
    if push:
        ...
        for i, slab_boundary in enumerate(boundary):
            ...
            if valid:
                ...
                valid_areas.append(
                    {
                        "polygon": concept_geo.polygon_from_polyline(slab_boundary),
        ...
        if valid_areas:
            ...
            logger.append("No valid slab areas provided.")
        return logger
